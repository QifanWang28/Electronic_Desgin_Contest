            ...
            for blob in blobs:
                if (blob.area() <= 20000):
                    ...
                    if (abs(y1 - y2) == 0):  # 检测垂直
                        ...
                        if (y2 - y4 > abs(x3 - x4)):
                            if(count>=100):
                                if((if_black(x1,y1)==0 or count<101)and process!=1 and finished==0):
                                    x1 = x1+0.01*(x3-x1)+ 0.01*(x2-x1)
                                    y1 = y1+0.01*(y3-y1)+ 0.01*(y2-y1)
                                if((if_black(x2,y2)==1 or count<101)and process!=2 and process!=1):
                                    x2 = x2+0.01*(x1-x2)+0.01*(x4-x2)
                                    y2 = y2+0.01*(y4-y2)+0.01*(y1-y2)
                                    print(2)
                                if((if_black(x3,y3)==0 or count<100)and finished==0 and process!=3):
                                    x3 = x3+0.01*(x4-x3)+0.01*(x1-x3)
                                    y3 = y3+0.01*(y4-y3)+0.01*(x1-x3)
                                if((if_black(x4,y4)==0 or count<100)and process!=3 and process!=2):
                                    x4 = x4+0.01*(x3-x4)+0.01*(x2-x4)
                                    y4 = y4+0.01*(y3-y4)+0.01*(y2-y4)
                            ...
                            if(count>=100):
                                if((if_black(x1,y1)==0 or count<100) and  process!=1 and finished==0 ):
                                    x1 = x1+0.01*(x2-x1) + 0.01*(x3-x1)
                                    y1 = y1+0.01*(y2-y1)+ 0.01*(y3-y1)
                                   # print(1)
                                if((if_black(x2,y2)==0 or count<100) and process!=2 and process!=1):
                                    x2 = x2+0.01*(x1-x2)+0.01*(x4-x2)
                                    y2 = y2+0.01*(y1-y2)+0.01*(y4-y2)
                                    print(2)
                                if((if_black(x3,y3)==0 or count<100) and finished==0 and process!=3):
                                    x3 = x3+0.01*(x1-x3)+0.01*(x4-x3)
                                    y3 = y3+0.01*(y4-y3)+0.01*(y1-y3)
                        ...
                        img.draw_cross((int(x3_new), int(y3_new)), color=(255, 0, 0))
                        img.draw_cross((int(x4_new), int(y4_new)), color=(255, 0, 0))
                        #print(img.get_pixel(int(x2),int(y2)))

                        #img.draw_cross((int(x1), int(y1)), color=(255, 0, 0))
                        #img.draw_cross((int(x2), int(y2)), color=(255, 0, 0))
                        #img.draw_cross((int(x3), int(y3)), color=(255, 0, 0))
                        #img.draw_cross((int(x4), int(y4)), color=(255, 0, 0))
