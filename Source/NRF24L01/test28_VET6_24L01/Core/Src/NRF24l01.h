...
//SPI片选信号
#define Clr_NRF24L01_CSN     HAL_GPIO_WritePin(CS_24L01_GPIO_Port, CS_24L01_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_CSN     HAL_GPIO_WritePin(CS_24L01_GPIO_Port, CS_24L01_Pin, GPIO_PIN_SET)

//NRF2401_IRQ数据输入
#define READ_NRF24L01_IRQ   HAL_GPIO_ReadPin(INT_24L01_GPIO_Port, INT_24L01_Pin)
